...
const Setting = () => {
    ...
    const {data: projData, refetch: projRefetch} = useFetch("https://project-pulse-backend-nine.vercel.app/projects")
    const {data: taskData, refetch: taskRefetch} = useFetch("https://project-pulse-backend-nine.vercel.app/tasks")
    ...
    async function handleTaskDelete(taskId){
        try{
            ...
            const response = await axios.delete(`https://project-pulse-backend-nine.vercel.app/tasks/${taskId}`,{
                headers: {
    ...
    async function handleProjDelete(projId){
        try{
            ...
            const response = await axios.delete(`https://project-pulse-backend-nine.vercel.app/projects/${projId}`,{
                headers: {
                    Authorization: `Bearer ${token}`
                }
            })
    ...
    return (
            <div className="dbFullScreen">
                ...
                <div className="col-lg-9 col-xl-10 col-12 settingBody">
                    {taskData && projData
                    ?
                    <div>
                        <div className="container">
                            ...
                            <div className="fs-lg-5">
                                ...
                                <div className="settingTables">
                                    <div className="mySettingDiv"> 
                                        <table className="mySettingTable">
                                        <thead>
                                            <tr>
